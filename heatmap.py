...
def get_params():
    params = {
        'weight': '/root/autodl-tmp/ultralytics-yolo11-main/runs/train/exp-v11-3+2+7-b32-e700--1 /weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/autodl-tmp/ultralytics-yolo11-main/dataset/56-min-1560/images/test', 'result/exp-v11-3+2+7-2')