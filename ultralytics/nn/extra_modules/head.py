...
__all__ = ['Detect_DyAlignHead',  'Pose_DyAlignHead', 'OBB_DyAlignHead',]
...
class Detect_DyAlignHead(nn.Module):
    ...
    def __init__(self, nc=80, nm=32, npr=256, hidc=256, ch=()):
        ...
        self.detect = Detect_DyAlignHead.forward
...
class Pose_DyAlignHead(Detect_DyAlignHead):
...
class OBB_DyAlignHead(Detect_DyAlignHead):
    """YOLOv8 OBB detection head for detection with rotation models."""
